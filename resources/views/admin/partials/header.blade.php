...
<div class="page-header-inner ">
    ...
    <div class="page-logo">
        <a href="#">
            <img src="{{asset('admin/layouts/layout/img/logo.png')}}" alt="logo" class="logo-default"/> </a>
                    ...
                    <li>
                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('admin/layouts/layout3/img/avatar2.jpg')}}"
                            ...
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('admin/layouts/layout3/img/avatar3.jpg')}}"
                                                             class="img-circle" alt=""> </span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('admin/layouts/layout3/img/avatar1.jpg')}}"
                                                             class="img-circle" alt=""> </span>
                                    <span class="subject">
